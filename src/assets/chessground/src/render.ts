...
import {createEl, key2pos} from './util'
  ...
  while (el) {
    ...
    if (isPieceNode(el)) {
      ...
      if (el.cgDragging && (!curDrag || curDrag.orig !== k)) {
        ...
        translate(el, posToTranslate(key2pos(k), asWhite), asWhite);
        el.cgDragging = false;
      }
      ...
      if (pieceAtKey) {
        ...
        if (anim && el.cgAnimating && elPieceName === pieceNameOf(pieceAtKey)) {
          ...
          translate(el, posToTranslate(pos, asWhite), asWhite);
  ...
  for (const j in piecesKeys) {
    ...
    if (!samePieces[k]) {
      ...
      if (pMvd) {
        ...
        translate(pMvd, posToTranslate(pos, asWhite), asWhite);
      }
      ...
      // might be a bad idea
        ...
        translate(pieceNode, posToTranslate(pos, asWhite), asWhite);
